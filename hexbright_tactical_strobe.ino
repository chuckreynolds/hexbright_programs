/*
  Hexbright firmware: Dazzle Mod
  @ChuckReynolds 12/2012

  Dazzler flashes while the button is held down (working)
  First click is 100% bright  (not yet)
  Second click is 40% bright  (not yet)
  Third is off  (not yet)
*/
